...
// const std::string
// filePath("/home/chengxing/CLionProjects/sddmm-gpu/autoTestTool/results_dataset_of_1/dataset/bcsstk30/bcsstk30.mtx");
...
class Options {
 ...
 private:
  ...
  std::unordered_set<std::string> shortOptions_ = {"-F", "-f", "-K", "-k",
                                                   "-A", "-a", "-B", "-b"};
