...
const int NUMBER_OF_MATRIX_A_TILE_MEMORY_ACCESSES_PER_WARP =
    MATRIX_A_TILE_SIZE_PER_BLOCK / NUM_OF_WARP_X_PER_BLOCK * NUM_OF_Y_PER_BLOCK;

const int NUMBER_OF_MATRIX_B_TILE_MEMORY_ACCESSES_PER_WARP =
    MATRIX_B_TILE_SIZE_PER_BLOCK / NUM_OF_WARP_X_PER_BLOCK * NUM_OF_Y_PER_BLOCK;
