...
class CuSparseSDDMM {
 public:
  CuSparseSDDMM(const Matrix<float> &mtxA,
  ...
  ~CuSparseSDDMM() {
      cusparseDestroyDnMat(mtxA_);
      cusparseDestroyDnMat(mtxB_);
      cusparseDestroySpMat(mtxS_);
  ...
  void sddmm() {
      ...
      cusparseSDDMM_bufferSize(
          ...
          CUSPARSE_OPERATION_NON_TRANSPOSE,
          &alpha_, mtxA_, mtxB_, &beta_, mtxS_, CUDA_R_32F,
