...
bash testTool.sh -f ../dataset/dlmc/rn50_matrices.txt -p ./build_isratnisa/isratnisa-gpu -n isratnisa_results
bash testTool.sh -f ../dataset/dlmc/transformer_matrices.txt -p ./build_isratnisa/isratnisa-gpu -n isratnisa_results_1
